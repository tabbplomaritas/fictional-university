...
const search = new _modules_Search__WEBPACK_IMPORTED_MODULE_3__["default"](); // Allow new JS and CSS to load in browser without a traditional page refresh
...
class HeroSlider {
  constructor() {
    if (document.querySelector(".hero-slider")) {
      ...
      const dotCount = document.querySelectorAll(".hero-slider__slide").length; // console.log(dotCount);
      ...
      console.log(dotHTML); // Add the dots HTML to the DOM
      ...
      <div class="row">
        ...
        ${results.programs.length ? "</ul>" : ""}
          <h2 class="search-overlay__section-title">Professors</h2>
           ${results.professors.length ? '<ul class="professor-cards">' : `<p>No professors match that search.</p> <a href=${universityData.root_url}/professors>View All Professors</a>`}
        ...
        <div class="one-third">
          ...
          ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campuses match that search.</p><a href=${universityData.root_url}/campuses>View All Campuses</a>`}
